...
class ResendBookingConfirmation extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        // echo $request->booking_reference_number;
        // echo $booking;
        $emailToSend = new BookingConfirmation($booking, $camaya_transportations,$request->booking_reference_number);

        if ($booking->status == 'pending') {
            $emailToSend = new ResendBookingConfirmationMail($booking, $camaya_transportations,$request->booking_reference_number);
        }
