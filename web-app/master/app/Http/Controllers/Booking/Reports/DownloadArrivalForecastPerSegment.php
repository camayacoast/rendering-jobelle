...
use App\Exports\Booking\ArrivalForecastPerSegmentExport;
...
class DownloadArrivalForecastPerSegment extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        foreach ($bookings as $key => $booking) {
            ...
            switch($booking['mode_of_transportation']){
                case "camaya_transportation":
                    $transpo = "ferry";
                    break;
                case "camaya_transportation_ferry":
                    $transpo = "ferry";
                    break;
                case "camaya_transportation":
                    $transpo = "bus";
            ...
            if ($booking['mode_of_transportation'] === 'camaya_transportation' || $booking['mode_of_transportation'] === "camaya_transportation_ferry") {
                // Get routes for EST-CMY and EST-FTT
                // $origin_location = Location::where('code', 'EST')->first();
                $destination_location_ids = Location::whereIn('code', ['FTT'])->pluck('id');
            ...
            } else if ($booking['mode_of_transportation'] === 'camaya_transportation_bus') {
                // Get routes for EST-CMY and EST-FTT
                // $origin_location = Location::where('code', 'EST')->first();
                // $destination_location_ids = Location::whereIn('code', ['CMY', 'FCT'])->pluck('id');
        ...
        // return $array;
        return Excel::download(new ArrivalForecastPerSegmentExport($array),
            'report.xlsx'
        );
    }
}
