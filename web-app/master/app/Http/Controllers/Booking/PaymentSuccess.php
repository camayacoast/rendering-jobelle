            ...
            if( $responseArr['paymentStatus'] === 'PAYMENT_SUCCESS' ) {
                ...
                if ($total_balance <= $total_payment_amount) {
                    ...
                    Mail::to($bookingDetails->customer->email)
                        ...
                        ->send(new BookingConfirmation($bookingDetails, $camaya_transportations,$request->booking_reference_number));
                ...
                if ($payments) {
                    ...
                    if ($total_balance <= $total_payment_amount) {
                        ...
                        Mail::to($booking->customer->email)
                                            ->cc($additional_emails)
                                            ->send(new BookingConfirmation($booking, $camaya_transportations,$bookingReferenceNumber->booking_reference_number));
