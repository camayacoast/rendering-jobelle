...
class CreatePackage extends Controller
{
    ...
    public function __invoke(CreatePackageRequest $request)
    {
        ...
        $newPackage = Package::create([
            'meal_inclusion' => $request->input("include_Meal"),
            'name' => $request->name,
            ...
            'weekday_rate' => isset($request->weekday_rate)?$request->weekday_rate : $request->weekend_rate,
        ...
        if (isset($request->allowed_roles)) {
            ...
            // dd($allowed_roles_to_save);
            // return gettype($allowed_roles_to_save);
        ...
        $package = $newPackage;
        $package['allowed_roles'] = $newPackage->allowedRoles()->pluck('role_id')->toArray();
