...
class ConfirmBooking extends Controller
{
    ...
    public function __invoke(ConfirmBookingRequest $request)
    {
        ...
        if ($booking->mode_of_transportation == 'camaya_transportation' || $booking->mode_of_transportation == 'camaya_transportation_ferry' || $booking->mode_of_transportation == 'camaya_transportation_bus') {
        ...
        Mail::to($booking->customer->email)
                            ...
                            ->send(new BookingConfirmation($booking, $camaya_transportations,$request->reference_number));
