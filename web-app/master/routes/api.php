...
use App\Http\Controllers\Booking\SmsNotification;
...
Route::prefix('booking')->group(function () {
  ...
  Route::get("view-booking-meals/{refno}",'Booking\ViewBookingMealsController')->middleware("auth:sanctum");
  ...
  Route::put('stub/update/category', 'Booking\UpdateStubCategory')->middleware("auth:sanctum");
    ...
    // Meal9
    Route::get('meals', 'Booking\MealList')->middleware("auth:sanctum");
    Route::get('meals/available', 'Booking\MealListAvailable');
    Route::post('meal/create', 'Booking\CreateMeal')->middleware("auth:sanctum");
    Route::put('meal/delete/{mealId}', 'Booking\DeleteMeal')->middleware("auth:sanctum");

    //Guest Meal
    Route::get('guest/meals', 'Booking\GuestMealList')->middleware("auth:sanctum");

    Route::get('guest/meals-report', 'Booking\GuestMealReport')->middleware("auth:sanctum");
    Route::get('guest/meals-export', 'Booking\GuestMealExport')->middleware("auth:sanctum");


    Route::put('guest/meals/scan', 'Booking\GuestMealClaim')->middleware("auth:sanctum");
...
Route::prefix('sales-admin-portal')->group(function () {
  ...
  Route::post('delete-client', 'SalesAdminPortal\DeleteClient')->middleware("auth:sanctum");
...
Route::prefix('one-bits')->group(function () {
  ...
  Route::get('schedules', 'OneBITS\ScheduleList')->middleware("auth:sanctum");
});
...
Route::prefix('sms-notification')->group(function () {

  Route::post('send-bulk-message', [SmsNotification::class, 'sendBulkMessage'])->middleware("auth:sanctum");
  Route::post('import-recepients', [SmsNotification::class, 'importRecepients'])->middleware("auth:sanctum");
  Route::post('send-import-bulk-message', [SmsNotification::class, 'sendImportBulkMessage'])->middleware("auth:sanctum");
  Route::post('download-recepient-template', [SmsNotification::class, 'exportRecepientTemplate'])->middleware("auth:sanctum");
  Route::post('download-event-job', [SmsNotification::class, 'exportEventJob'])->middleware("auth:sanctum");
  Route::get('get-messages', [SmsNotification::class, 'getMessages'])->middleware("auth:sanctum");
  Route::get('get-accounts', [SmsNotification::class, 'getAccounts'])->middleware("auth:sanctum");
  Route::get('get-sms-logs/{subject}', [SmsNotification::class, 'getSmslogs'])->middleware("auth:sanctum");
  Route::post('create-sms-subject', [SmsNotification::class, 'createSubject'])->middleware("auth:sanctum");
  Route::get('get-sms-subjects', [SmsNotification::class, 'getSubjects'])->middleware("auth:sanctum");
  Route::post('create-sms-event', [SmsNotification::class, 'createEvent'])->middleware("auth:sanctum");
  Route::get('get-sms-event', [SmsNotification::class, 'getEvents'])->middleware("auth:sanctum");
  Route::post('update-sms-event', [SmsNotification::class, 'updateEvent'])->middleware("auth:sanctum");
  Route::post('remove-sms-event', [SmsNotification::class, 'removeEvent'])->middleware("auth:sanctum");
  Route::get('get-sms-job-history', [SmsNotification::class, 'getEventsJobHistory'])->middleware("auth:sanctum");
  Route::post('remove-event-job', [SmsNotification::class, 'removeJobs'])->middleware("auth:sanctum");
