<table>
    <thead>
        ...
        <tr>
            ...
            <th rowspan="2" align="center" valign="center" style="font-weight: bold;">Booking Tags</th>
            ...
            <th rowspan="2" align="center" valign="center" style="font-weight: bold;">Package Name</th>
        </tr>
        <tr>
    ...
    @foreach($reports as $report)
        <tr>
            ...
            <td align="center">
                <div>
                    @foreach ($report['inclusions'] as $inclusion)
                        @if(!empty($inclusion['package']))
                         <p>{{$inclusion['item']}}</p>
                        @endif
