    ...
    <div class="wrapper">
        ...
        return strtotime($item['schedule']['trip_date'] . ' ' . $item['schedule']['start_time']);
                                ...
                                <tr>
                                    <td>
                                        <small>
                                            ...
                                            <div>ETA:
                                                {{ date('h:i A', strtotime($trip_booking['schedule']['end_time'])) }}
                                            </div>
                                        </small>
                                    </td>
                ...
                <small style="color: red;">
                    <ul>
                        <li>Check-in counters open as early as 1.5 hours before departure, and closes 30 minutes before
                            departure.</li>
                        <li>Boarding gate opens 1 hour before departure, and closes 15 minutes before departure.</li>
                        <li>Guests will not be allowed to board the ferry after check-in counters and boarding gates are
                            closed.</li>
                    </ul>
                </small>
            @endif
