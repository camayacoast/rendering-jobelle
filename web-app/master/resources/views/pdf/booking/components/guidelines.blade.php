...
@if (
    $booking['mode_of_transportation'] == 'camaya_transportation' ||
        $booking['mode_of_transportation'] == 'camaya_transportation_ferry')
    <p><strong>Ferry Terminal Address:</strong> Esplanade Seaside Terminal, Seaside Blvd., SM MOA Complex,
        Pasay&nbsp;City</p>
    ...
    <ol>
        ...
        <li><strong>Check-in Counter:</strong> Booking Confirmation &amp; Government issued ID or any equivalent ID.
        </li>
    ...
    <ol>
        ...
        <li>All guests must be pre-booked. Same day booking and on the day request for additional guests are not
            allowed. </li>
        <li>Guest or passenger must arrive at the Ferry Terminal 1 hour and 30 minutes and may check in before the
            departure time of the ferry. </li>
        ...
        <li>The ferry booking of the guest or passenger arriving beyond the mentioned cut-off time above will be
            forfeited automatically.</li>
        <li>No talking and unnecessary phone calls while inside the ferry.</li>
        <li>Guest or passenger is advised to refrain from standing or walking inside the ferry unless it is necessary.
        </li>
...
@if ($booking['mode_of_transportation'] == 'camaya_transportation_bus')
    <p><strong>BUS Terminal address:</strong> FAB Central Terminal, Freeport Area of Bataan, Mariveles, Bataan Camaya Coast Parking</p>

    <h4>BUS TRAVEL REQUIREMENTS and REMINDERS</h4>
    ...
    <h4>BUS CHECK-IN/BOARDING REMINDERS AND GUIDELINES</h4>
    <ol>
        <li>Bus Service is Pick Up and Drop Off Service only from FAB Central Terminal, Mariveles to Camaya Coast,
            Mariveles</li>
        <li>Arrive 30 mins early before bus departure at FAB Central Terminal. </li>
        <li>Find Camaya Coast Parking Area. </li>
        <li>Show your QR Code for check-in to our Camaya Coast Staff</li>
        <li>Board the Bus Shuttle with ease.</li>
        <li>Bringing of food and drinks are not allowed.</li>
    </ol>
@endif

@if ($booking['mode_of_transportation'] != 'camaya_transportation' && $booking['mode_of_transportation_ferry'] !== "camaya_transportation_ferry" && $booking['mode_of_transportation_bus'] !== "camaya_transportation_bus")
...
<ol>
    ...
    @if ($booking['mode_of_transportation'] != 'camaya_transportation')
        <li>Outside FOOD and DRINKS are not allowed inside the resort.</li>
    @endif
    <li>Rebooking made at least 5 days of the arrival date is free of charge. Any rebooking beyond the said period shall
        be charged in full.</li>
    <li>In case there is a rate difference between the original and rebooked dates, the higher rate shall be applied.
    </li>
    ...
    <li>Acts of God or extreme medical emergencies may be allowed upon Management's discretion. Supporting documents may
        be required.</li>
    <li>Any revisions or changes in bookings must be sent at <a href="mailto:reservations@camayacoast.com"
            target="_blank">reservations@camayacoast.com</a></li>
    ...
    <li><strong>ACTS OF GOD; FORTUITOUS EVENT</strong>
        <ol type="a">
            <li>Camaya Coast Management and its affiliates, directors, officers and employees shall not be liable for
                any delay or failure of performance of its/their obligation/s due to Acts of God or unforeseeable
                circumstances.</li>
            <li>Any additional expenses incurred from changes in the itinerary brought about by weather, road and local
                conditions shall be borne by the passengers or travel agency/tour operator.</li>
            <li>Any cancellation due to Acts of God or unforeseeable circumstances, changes in the Community Quarantine
                status as defined by law shall be settled equitably between Camaya Coast Management and guest/tour
                agency/tour operator taking into consideration the presence or absence of any contributory mitigating or
                aggravating factors from any of the parties.</li>
        </ol>
    </li>

    <li><strong>RELEASE AND WAIVER OF LIABILITY</strong>
        <p style="margin-top: 0px; margin-bottom: 0px;">Please be aware that the Camaya Coast Management, has taken
            reasonable steps and precautions to assure your safety while staying with us. In using our property,
            however, you do so at your own risk. Your voluntary checking-in to our hotels and/or entry to our Commercial
            Area indicates your agreement to release and hold the Camaya Coast Management its owners, affiliates, and
            agents, from any liability. Further, you agree:</p>
        <ol type="a">
            <li>To irrevocably and unconditionally waive and release and hold harmless from liability the Camaya Coast
                Management, its owners, affiliates, and agents from any and all liabilities, claims, actions, damages,
                costs, or expenses of any nature whatsoever whether in law or equity, known or unknown, occurring
                during, caused by, relating to, or arising in any way from staying or visiting the resort;</li>
            <li>To acknowledge and agree that you assume full responsibility for the security and safekeeping of your
                personal belongings and hereby waive any claims against the Camaya Coast Management for any loss,
                damage, or theft of such items, including but not limited to money, jewelry, and any other valuables
                brought within the premises of Camaya Coast.</li>
            <li>That the stay and visit to our resort may involve voluntary participation in physical activities both
                indoors and outdoors, and certain exposure to walks, steps, paths, and roads that are uneven. With
                these, and all related activities, there is a certain element of risk. By checking-in to our hotels or
                entering our Commercial Area, you hereby acknowledge that participation and use of facilities and
                grounds are at your own risk, and that you assume all responsibilities for any and all aspects of your
                participation including your guests, both adults and children;</li>
            <li>To irrevocably and unconditionally release and hold the Camaya Coast Management harmless from any
                financial or other liability for any injury, bodily harm, sickness, illness, or loss of life that you or
                your guests and company may suffer and from any economic harm or loss of property occurring during,
                caused by, relating to, or arising in any way out of staying at our resort;</li>
            <li>TO EXPRESSLY WAIVE AND RELEASE ANY AND ALL CLAIMS, NOW KNOWN OR HEREAFTER KNOWN, AGAINST THE CAMAYA
                COAST MANAGEMENT AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AFFILIATES, MEMBERS, SUCCESSORS, AND
                ASSIGNS, ON ACCOUNT OF INJURY, DEATH, OR PROPERTY DAMAGE ARISING OUT OF OR ATTRIBUTABLE TO USE OF CAMAYA
                COAST RESORT. YOU COVENANT NOT TO MAKE OR BRING ANY SUCH CLAIM AGAINST THE CAMAYA COAST MANAGEMENT, AND
                FOREVER RELEASE AND DISCHARGE THE CAMAYA COAST MANAGEMENT FROM LIABILITY UNDER SUCH CLAIMS;</li>
            <li>TO DEFEND, INDEMNIFY, AND HOLD HARMLESS THE CAMAYA COAST MANAGEMENT, AND ITS OFFICERS, DIRECTORS,
                EMPLOYEES, AGENTS, AFFILIATES, MEMBERS, SUCCESSORS, AND ASSIGNS, AGAINST ANY AND ALL LOSSES, DAMAGES,
                LIABILITIES, DEFICIENCIES, CLAIMS, ACTIONS, JUDGMENTS, SETTLEMENTS, INTEREST, AWARDS, PENALTIES, FINES,
                COSTS, OR EXPENSES OF WHATEVER KIND, INCLUDING REASONABLE ATTORNEY FEES, FEES AND OTHER RELATED COSTS.
            </li>
        </ol>
        <p>This Release and Waiver of Liability shall not apply to any claims arising from the negligence of the Camaya
            Coast Management, its owners or agents.</p>
    </li>
</ol>
...
<p style="text-align: center; margin: 0px;"><strong>Thank you and we look forward to seeing you at Camaya Coast!</strong>
</p>
