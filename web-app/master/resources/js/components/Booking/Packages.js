...
import { Typography, Tag, Row, Col, Card, Drawer, Button, Grid, Form, Input, Select, message, DatePicker, InputNumber, notification, Upload, Modal, Carousel, Space, Checkbox } from 'antd'
...
function Page(props) {
    ...
    const handleViewPackage = (item) => {
        ...
        // const includeMeal = item.meal_inclusion === 1;
        var includeMeal = "";

        if(item.meal_inclusion === 0) {
            includeMeal = "None"
        }
        else if(item.meal_inclusion === 1) {
            includeMeal = "Breakfast, Lunch and Dinner"
        }
        else if(item.meal_inclusion === 2) {
            includeMeal = "Breakfast"
        }
        else if(item.meal_inclusion === 3) {
            includeMeal = "Lunch"
        }
        else if(item.meal_inclusion === 4) {
            includeMeal = "Dinner"
        }
        else if(item.meal_inclusion === 5) {
            includeMeal = "Breakfast and Lunch"
        }
        else if(item.meal_inclusion === 6) {
            includeMeal = "Lunch and Dinner"
        }
        else if(item.meal_inclusion === 7) {
            includeMeal = "Dinner and Breakfast"
        }
        ...
        <Row gutter={[12,12]}>
            ...
            <Col xl={12}>
                ...
                rules={[
                    ...
                    <Select>
                        ...
                        <Select.Option value="camaya_transportation">Camaya transportation (Ferry)</Select.Option>
                        <Select.Option value="camaya_transportation_bus">Camaya transportation (Bus)</Select.Option>
                    </Select>
                </Form.Item>
            </Col>
            <Col xl={12}>
            ...
            <Col xl={12}>
                <Form.Item
                    name="include_Meal"
                    label="Meals"
                    initialValue={0} // Set the initial value to false when item is undefined
                >
                   {/* < <Checkbox>
                        Include Meal
                    </Checkbox>> */}
                    ...
                    <Select>
                        ...
                        <Select.Option value="1">Breakfast, Lunch and Dinner</Select.Option>
                        <Select.Option value="2">Breakfast</Select.Option>
                        <Select.Option value="3">Lunch</Select.Option>
                        <Select.Option value="4">Dinner</Select.Option>
                        <Select.Option value="5">Breakfast and Lunch</Select.Option>
                        <Select.Option value="6">Lunch and Dinner</Select.Option>
                        <Select.Option value="7">Dinner and Breakfast</Select.Option>
