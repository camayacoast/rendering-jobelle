                        ...
                        return <tr key={key}>
                            <td>
                                <table border={1} style={{width: '500px'}}>
                                    <tbody>
                                    <tr>
                                        <td style={{backgroundColor: '#a9d08d'}} colSpan={7} align="center">{moment(item[0]).format('MMMM D - dddd')}</td>
                                    </tr>
                                    <tr>
                                        <td style={{backgroundColor: '#a9d08d'}} rowSpan={2} align="center">GUEST TYPE</td>
                                        <td style={{backgroundColor: '#a9d08d'}} colSpan={3} align="center">DTT</td>
                                        <td style={{backgroundColor: '#a9d08d'}} colSpan={3} align="center">OVERNIGHT</td>
                                    </tr>
                                    <tr>
                                        <td style={{backgroundColor: '#a9d08d'}} align="center">FERRY</td>
                                        <td style={{backgroundColor: '#a9d08d'}} align="center">BUS</td>
