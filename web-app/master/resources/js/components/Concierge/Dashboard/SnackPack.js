                ...
                <Table
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            render: (text, record) => (!_.find(record.active_trips, i => i.destination_code == 'CMY' || i.destination_code == 'FTT') && (record.booking.mode_of_transportation == 'camaya_transportation' || record.booking.mode_of_transportation == 'camaya_transportation_ferry' || record.booking.mode_of_transportation == 'camaya_transportation_bus' )) ? 'undecided' : record.booking.mode_of_transportation,
                            filters: [
                                { text: '', value: 'undecided' },
                                ...
                                {text:"Camaya Transportation (Default)", value:'camaya_transportation'},
                                { text: 'Camaya transportation (Ferry)', value: 'camaya_transportation_ferry' },
                                {text:"Camaya Transportation (Bus)",value: 'camaya_transportation_bus'}
                            ],
                            defaultFilteredValue: ["",'own_vehicle', 'van_rental', 'undecided', 'company_vehicle', 'camaya_vehicle', 'camaya_transportation','camaya_transportation_ferry','camaya_transportation_bus'],
