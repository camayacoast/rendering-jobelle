...
const MealsComponent = React.lazy( () => import('components/Booking/Meals'))
...
import Icon, { HomeOutlined, CarOutlined, TeamOutlined, LoginOutlined, UserAddOutlined, ProfileFilled} from '@ant-design/icons'
                    ...
                    <Row gutter={[32,0]}>
                        <Col xl={5} xs={24}>
                            ...
                            >
                                ...
                                <Menu.Item className="rounded-12" key="/booking/inventory/meals" icon={<Icon component={ProfileFilled} />}>
                                    <NavLink to="/booking/inventory/meals">Meals</NavLink>
                                </Menu.Item>
                        ...
                        <Col xl={19} xs={24}>
                            <Switch>
                                ...
                                <Route path={`/booking/inventory/meals`} exact render={ () => <MealsComponent/>}/>
