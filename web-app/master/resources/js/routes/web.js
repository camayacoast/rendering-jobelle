...
const SmsNotification = lazy(() => import('screens/Booking/SmsNotification'))
...
const routes = [
    ...
    // SMS Notification
    {
        ...
        name: 'sms-notification-page',
        exact: false,
        auth: true,
        component: (props) => <Suspense fallback={<Loading/>}><SmsNotification {...props}/></Suspense>
    }, 
